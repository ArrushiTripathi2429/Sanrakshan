const VILLAGES_DATA = [
  ...
  { id: 10, name: "Maharajganj",      hi: "महाराजगंज",       lat: 26.1316, lng: 81.4574, type: "town" },
  ...
  { id: 20, name: "Fatehpur Chaurasi",hi: "फतेहपुर चौरासी", lat: 26.1547, lng: 81.5800, type: "village" },
  ...
  { id: 25, name: "Kunda",            hi: "कुंडा",           lat: 26.0097, lng: 81.5147, type: "village" },
  ...
  { id: 30, name: "Soraon",           hi: "सोरांव",          lat: 26.3862, lng: 81.5621, type: "village" },
  ...
  { id: 39, name: "Bisawan",          hi: "बिसवां",          lat: 26.1453, lng: 81.6497, type: "village" },
  { id: 40, name: "Maholi",           hi: "महोली",           lat: 26.2980, lng: 81.6231, type: "village" },
  ...
  { id: 45, name: "Musafirkhana",     hi: "मुसाफिरखाना",     lat: 26.3656, lng: 81.7298, type: "village" },
  ...
  { id: 53, name: "Shivgarh",         hi: "शिवगढ़",          lat: 26.2722, lng: 81.6489, type: "village" },
  ...
  { id: 56, name: "Gauriganj",        hi: "गौरीगंज",         lat: 26.4743, lng: 81.5791, type: "village" },
];

    ...
    <>
      ...
      <div className="fw-wrap">
        ...
        <aside className="fw-sidebar">
          <div className="fw-logo">SRA<span>/</span>sys</div>
          <button className="fw-nav active"><span>◎</span> Dashboard</button>
          <button className="fw-nav"><span>⊕</span> New Report</button>
          <button className="fw-nav"><span>≡</span> My Reports</button>
              ...
              {submitted ? (
                ...
                <div className="fw-voice-center">
                  <div className="fw-mic-wrap">
                    {recording && (<><div className="fw-ripple"/><div className="fw-ripple"/><div className="fw-ripple"/></>)}
                    <button
          ...
          <div className="fw-reports">
            ...
            {reports.length === 0 ? (
              <div className="fw-empty">
                ...
                <div className="fw-empty-text">No reports submitted yet.<br />Use voice or form above to report an issue.</div>
              </div>
            ) : (
              reports.map((r) => (
